            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">작성자 : ${sessionScope.mb_db.id} </h6>
                </div>
                <form action="/notice/noticeboardwrite" method="post">
                <div class="card-body">
                	<textarea name="title" class="form-control col-sm-10" rows="1" placeholder="글 제목"></textarea>
                	<br>
